...
const S: Dict = {
  ...
  showPheromones: { en: 'show trails', es: 'mostrar rastros' },
  ...
  in_pheroX: { en: 'trail ◀▶', es: 'rastro ◀▶' },
  in_pheroY: { en: 'trail ▲▼', es: 'rastro ▲▼' },
  ...
  renameHint: { en: 'Enter to save · empty clears', es: 'Enter para guardar · vacío borra' },
  save: { en: 'save', es: 'guardar' },
  now: { en: 'now', es: 'ahora' },
  tickWord: { en: 'tick', es: 'tick' },
  hist_births: {
    en: 'born over time → · click a node to name it',
    es: 'aparición en el tiempo → · clic en un nodo para nombrarlo',
  },
  ...
  leg_low: { en: 'low', es: 'bajo' },
  leg_high: { en: 'high', es: 'alto' },
  leg_lineage: { en: 'each colour = a family', es: 'cada color = una familia' },
  leg_safe: { en: 'harmless', es: 'inofensiva' },
  leg_toxic: { en: 'toxic', es: 'tóxica' },
  ...
  g_phero: { en: 'pheromones', es: 'feromonas' },
  ...
  // Extinct lineages in the cladogram + their likely cause of death.
  hist_extinctHint: {
    en: '○ = extinct · hover a node for its story',
    es: '○ = extinto · pasa el ratón por un nodo para su historia',
  },
  ext_extinct: { en: 'extinct', es: 'extinto' },
  ext_alive: { en: 'alive', es: 'vivo' },
  ext_at: { en: 'tick', es: 'tick' },
  ext_by: { en: 'by', es: 'por' },
  ext_cause: { en: 'likely cause', es: 'causa probable' },
  ext_stillborn: { en: 'barely took hold', es: 'apenas llegó a existir' },
  ext_predated: { en: 'hunted to extinction', es: 'cazado hasta la extinción' },
  ext_slowfeeder: { en: 'too slow to feed', es: 'demasiado lento para comer' },
  ext_starved: { en: 'starved in a famine', es: 'muerto de hambre en una hambruna' },
  ext_lost: { en: 'never learned to find food', es: 'nunca aprendió a buscar comida' },
  ext_outcompeted: { en: 'outcompeted by fitter clades', es: 'desplazado por linajes más aptos' },
  ext_faded: { en: 'dwindled away', es: 'se fue apagando poco a poco' },
